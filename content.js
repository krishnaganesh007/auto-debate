// Content script for ArgueWise
let debatePopup = null;
let selectedText = "";

console.log("ArgueWise content script loaded successfully!");
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  if (request.action === "startDebate") {
    ...
    console.log("Starting debate with text:", selectedText);
    showDebatePopup();
  }
});
...
function showDebatePopup() {
  ...
  debatePopup.innerHTML = `
    <div class="debate-popup-header">
      <div class="popup-title">🗣️ ArgueWise</div>
...
function setupEventListeners() {
  // Close button
  document.getElementById('close-popup-btn').addEventListener('click', closeDebatePopup);
